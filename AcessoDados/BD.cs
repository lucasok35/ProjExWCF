...
namespace AcessoDados
{
    public class BD
    {
        ...
        public string StringConexao
        {
            ...
            {
                //SQL SERVER 2008
                //_stringConexao = @"Data Source=ANDRESIL2\SQLEXPRESS;Initial Catalog=aula2;Integrated Security=SSPI;";
                _stringConexao = @"Data Source = LAPTOP-L0VGNHMK\MSSQLSERVER2017; Initial Catalog = AulaWCF; User ID = sa; Password = 4991;";
